<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="wfRequestedMed.aspx.cs" Inherits="SPAAPP.wfRequestedMed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <div id="d" class="row" style="padding-left:10px;padding-right:5px;justify-content:center;margin:5px;">
        ...
        <asp:TemplateField HeaderText="Add">
            <ItemTemplate>                
                <asp:Button ID="btnAdd" CssClass="btn btn-warning"  CausesValidation="true" ValidationGroup="UpdatingGrid"  CommandArgument='<%# Bind("ID") %>'  CommandName="Button22" runat="server" Text="Add" />
            </ItemTemplate>         
        </asp:TemplateField> 
